...
Input (checklist.json) — SYNTHETIC EXAMPLE:
{
  ...
  "items": [
    {"category": "Government-issued ID", "collected": true, "notes": "Received via email 8/29"},
    {"category": "Last 3 months account statements", "collected": true, "notes": ""},
    {"category": "Proof of address", "collected": false, "notes": "Requested 8/30, no response yet"},
