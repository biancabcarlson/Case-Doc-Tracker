...
Input (checklist.json) — SYNTHETIC EXAMPLE:
{
  ...
  "items": [
    ...
    {"category": "Last 3 months account statements", "status": "received", "notes": ""},
...
"status" is one of: "received", "rejected", "not_collected". "rejected" is
distinct from "not_collected" — it means the customer submitted something
that wasn't acceptable, so the write-up asks them to resend that specific
item rather than a generic re-request.
