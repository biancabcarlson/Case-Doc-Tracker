...
A lightweight, shareable checklist tracker for case documentation. Define the categories of documents a case needs, check items off as they're collected, and generate a status report showing what's done and what's outstanding.
...
No fraud logic, no scoring, no prescribed methodology — just a tracking utility for a checklist you define yourself. Includes a browser-based live demo (`index.html`, linked above) that runs entirely client-side; nothing is saved or uploaded.
